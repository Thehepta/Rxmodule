...
import top.custom.hepta.entry.Arm64MarshmallowEntry;
...
public final class Pine {
    ...
    private static void initBridgeMethods() {
        try {
            ...
            if (arch == ARCH_ARM64) {
                entryClassName = "top.custom.hepta.entry.Arm64Entry";
                paramTypes = new Class<?>[] {long.class, long.class, long.class,
                        long.class, long.class, long.class, long.class};
            } else if (arch == ARCH_ARM) {
                entryClassName = "top.custom.hepta.entry.Arm32Entry";
                paramTypes = new Class<?>[] {int.class, int.class, int.class};
            } else if (arch == ARCH_X86) {
                entryClassName = "top.custom.hepta.entry.X86Entry";
                paramTypes = new Class<?>[] {int.class, int.class, int.class};
