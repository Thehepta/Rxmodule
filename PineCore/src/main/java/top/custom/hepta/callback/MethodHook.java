package top.custom.hepta.callback;
...
public abstract class MethodHook {
     ...
     * gets reset, if you want to set an exception as the method thrown, use {@link top.custom.hepta.Pine.CallFrame#setThrowable(Throwable)}
     ...
     * If you want to set an exception as the method thrown, use {@link top.custom.hepta.Pine.CallFrame#setThrowable(Throwable)}
     * @param callFrame object that stores some info about info call.
     */
